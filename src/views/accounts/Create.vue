  ...
  <div>
    <CRow>
      <CCol col="12">
          ...
          <CCardHeader>
            <CCol col="12" style="font-size: 25px;"> إضافة حساب جديد</CCol>
          </CCardHeader>
          <CCardBody>
            <CRow>
               <CCol sm='6'>
...
<script>
import $ from 'jquery'
import NewAccountType from '@/components/NewAccountType.vue'
export default {
  name: 'createAccount',
  data: function () {
    return {
  ...
  methods: {
    ...
    createAccount: function (e) {
      ...
      this.postRequest(formData, this.$hostUrl + 'admin-dashboard/accounts', '/accounts')
    }
  }
}
